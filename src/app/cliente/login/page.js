...
// Cliente criado FORA da função para evitar loop de conexões
...
export default function ClientLoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Redirecionamento forçado para limpar a memória e carregar a sessão no Dashboard
      window.location.href = '/cliente/dashboard';

    } catch (err) {
      console.error("Erro no login:", err);
      setError('E-mail ou senha incorretos. Verifique suas credenciais.');
      setLoading(false); // Só para o loading se der erro, se der sucesso deixa rodando até mudar de tela
    }
  };
