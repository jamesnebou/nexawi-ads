  ...
  <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between mb-16 md:mb-32 group reveal-on-scroll opacity-0 translate-y-8 transition-all duration-700">
    ...
    >
      <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-white/30 rounded-full group-hover:bg-[#6be12f] transition-colors duration-500" />
        ...
        <section
          id="planos"
          className="relative z-10 py-20 md:py-24 px-6 max-w-7xl mx-auto"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            ...
            {/* Comercial (Mais Vendido) */}
            <div className="p-7 sm:p-8 md:p-10 rounded-3xl bg-gradient-to-b from-green-900/40 to-black backdrop-blur-xl border-2 border-[#6be12f] shadow-[0_0_20px_rgba(107,225,47,0.6)] transform md:-translate-y-6 relative hover:shadow-[0_0_60px_rgba(107,225,47,0.4)] transition-all duration-500 flex flex-col">
              ...
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-[#6be12f] text-black px-6 py-1.5 rounded-full text-xs sm:text-sm font-black tracking-wider shadow-[0_0_20px_rgba(107,225,47,0.6)] z-20">
                MAIS VENDIDO
              </div>

              <div className="relative z-10 flex flex-col h-full">
                <h3 className="text-xl sm:text-2xl font-bold mb-2 text-[#8cf059]">
                  Comercial
                </h3>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full py-3.5 sm:py-4 rounded-xl bg-[#6be12f] text-black hover:bg-[#8cf059] transition-all duration-300 font-black text-base sm:text-lg shadow-[0_0_20px_rgba(107,225,47,0.6)] hover:scale-105 text-center block"
                >
                  Assinar Comercial
                </a>
              </div>
