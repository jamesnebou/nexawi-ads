             ...
             <div className="flex-shrink-0 flex items-center justify-center relative">
              ...
              <div className="flex-1 min-w-0 flex flex-col gap-1 items-center sm:items-start w-full sm:w-auto">
                ...
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-gray-600 justify-center sm:justify-start">
                  ...
                  {anuncio.url_destino && (
                    // ALTERADO: Garante que a URL tenha o prefixo https://
                    <a
                      href={anuncio.url_destino.startsWith('http://') || anuncio.url_destino.startsWith('https://')
                            ? anuncio.url_destino
                            : `https://${anuncio.url_destino}`}
                      target="_blank"
