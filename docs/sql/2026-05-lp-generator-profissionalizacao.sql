-- Profissionalizacao do gerador de LPs NexaWi.
-- Rode no SQL Editor do Supabase antes de depender de biblioteca de imagens
-- e limites comerciais por plano.
...
comment on column public.planos.max_lps is 'Quantidade maxima de LPs publicadas por cliente/empresa. 0 significa ilimitado.';
comment on column public.planos.max_leads_mes is 'Quantidade maxima comercial de leads por mes. 0 significa ilimitado.';
comment on column public.planos.templates_premium is 'Permite acesso a templates premium do gerador de LP.';
